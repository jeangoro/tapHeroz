...
import { IonPage, IonContent, IonItem, IonLabel, IonButton, IonIcon, useIonToast, useIonViewDidEnter, IonRow, IonCol, IonImg } from "@ionic/react";
    ...
    <IonPage>
      ...
      <IonContent className="ion-padding">
        ...
        <div style={{ display: "flex", justifyContent: "space-around", marginTop: "20px" }}>
          ...
          <IonButton color="dark" onClick={() => shareLink(axios.defaults.baseURL + "register/?referer=" + user_infos_state.ID_JOUEUR, "")}>
            <IonIcon icon={logoX} />
          </IonButton>
        </div>
